...
```{r}
# outlier detection
#col<- c('OperatingSystems','SpecialDay','PageValues','ExitRates','BounceRates','ProductRelated_Duration','ProductRelated','Informational_Duration','Administrative_Duration','Administrative')
...
```
```{r}
# to get  the cluster for each record
result$cluster
```
```{r}
